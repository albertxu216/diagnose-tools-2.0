...
#define DIAG_IOCTL_TYPE_TCP_STATES (DIAG_IOCTL_TYPE_PMU + 1)
#define DIAG_IOCTL_TYPE_UDP (DIAG_IOCTL_TYPE_TCP_STATES + 1)
#define DIAG_IOCTL_TYPE_RESOURCE_IMAGE (DIAG_IOCTL_TYPE_UDP + 1)//添加信号
#define DIAG_IOCTL_TYPE_MIGRATE_IMAGE (DIAG_IOCTL_TYPE_RESOURCE_IMAGE + 1)//添加信号
#define DIAG_IOCTL_TYPE_SCHED_IMAGE (DIAG_IOCTL_TYPE_MIGRATE_IMAGE + 1)//添加信号
#define DIAG_IOCTL_TYPE_TEST_MAP (DIAG_IOCTL_TYPE_SCHED_IMAGE + 1)//添加信号
#define DIAG_IOCTL_TYPE_KEYTIME_IMAGE (DIAG_IOCTL_TYPE_TEST_MAP + 1)//添加信号
#define DIAG_IOCTL_TYPE_END (DIAG_IOCTL_TYPE_TEST_MAP + 1)
...
//2100
#define DIAG_BASE_SYSCALL_TCP_STATES \
	(DIAG_BASE_SYSCALL_PMU + DIAG_SYSCALL_INTERVAL)

//2150
#define DIAG_BASE_SYSCALL_UDP \
	(DIAG_BASE_SYSCALL_TCP_STATES + DIAG_SYSCALL_INTERVAL)

//2200
#define DIAG_BASE_SYSCALL_RESOURCE_IMAGE \
	(DIAG_BASE_SYSCALL_UDP + DIAG_SYSCALL_INTERVAL)//增加syscall信号值

//2250
#define DIAG_BASE_SYSCALL_MIGRATE_IMAGE \
	(DIAG_BASE_SYSCALL_RESOURCE_IMAGE + DIAG_SYSCALL_INTERVAL)//增加syscall信号值

//2300
#define DIAG_BASE_SYSCALL_SCHED_IMAGE \
	(DIAG_BASE_SYSCALL_MIGRATE_IMAGE + DIAG_SYSCALL_INTERVAL)//增加syscall信号值

#define DIAG_BASE_SYSCALL_TEST_MAP \
	(DIAG_BASE_SYSCALL_SCHED_IMAGE + DIAG_SYSCALL_INTERVAL)//增加syscall信号值

#define DIAG_BASE_SYSCALL_KEYTIME_IMAGE \
	(DIAG_BASE_SYSCALL_TEST_MAP + DIAG_SYSCALL_INTERVAL)//增加syscall信号值
...
enum diag_record_id {
	...
	et_tcp_states_base = et_pmu_base + DIAG_EVENT_TYPE_INTERVAL,
	et_tcp_states_detail,
	et_tcp_states_detail_now,
	et_tcp_states_total,

	et_udp_base = et_tcp_states_base + DIAG_EVENT_TYPE_INTERVAL,
	et_udp_detail,
	et_udp_dns_rcv,
	et_udp_dns_send,

	et_resource_image_base = et_udp_base + DIAG_EVENT_TYPE_INTERVAL,
	et_resource_image_detail,

	et_migrate_image_base = et_resource_image_base + DIAG_EVENT_TYPE_INTERVAL,
	et_migrate_image_detail,

	et_sched_image_base = et_migrate_image_base + DIAG_EVENT_TYPE_INTERVAL,
	et_sched_image_summary,
	et_sched_image_detail,

	et_test_map_base = et_sched_image_base + DIAG_EVENT_TYPE_INTERVAL,
	et_test_map_detail,

	et_keytime_image_base = et_test_map_base + DIAG_EVENT_TYPE_INTERVAL,
	et_keytime_image_detail,
