...
static struct diagnose_func all_funcs[] {
	...
	{"tcpstates", tcp_states_main, 0}, 
	{"udp", udp_main, 0}, 
	{"resource-image",resource_image_main,0},
	{"migrate-image",migrate_image_main,0},
	{"sched-image",sched_image_main,0},
	{"test-map", test_map_main, 0},
	{"keytime-image",keytime_image_main,0}
};
