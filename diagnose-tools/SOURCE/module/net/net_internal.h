...
extern int diag_net_ping_delay6_init(void);
extern void diag_net_ping_delay6_exit(void);
extern int diag_net_net_bandwidth_init(void);
extern void diag_net_net_bandwidth_exit(void);
extern int diag_net_tcp_states_init(void);
extern void diag_net_tcp_states_exit(void);
extern int diag_net_udp_init(void);
extern void diag_net_udp_exit(void);