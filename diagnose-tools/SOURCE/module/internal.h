...
struct diag_percpu_context {
	...
	struct sched_image_detail sched_image_detail;
...
int activate_resource_image(void);//增加内核态函数说明
int deactivate_resource_image(void);//增加内核态函数说明
int activate_migrate_image(void);//增加内核态函数说明
int deactivate_migrate_image(void);//增加内核态函数说明
int activate_sched_image(void);//增加内核态函数说明
int deactivate_sched_image(void);//增加内核态函数说明
int activate_test_map(void);//增加内核态函数说明
int deactivate_test_map(void);//增加内核态函数说明
int activate_keytime_image(void);//增加内核态函数说明
int deactivate_keytime_image(void);//增加内核态函数说明
