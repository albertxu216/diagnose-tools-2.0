...
static long diag_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
    ...
    case DIAG_IOCTL_TYPE_PMU:
        ...
        break;
    case DIAG_IOCTL_TYPE_TCP_STATES:
        ret = diag_ioctl_tcp_states(nr, arg);
        break;
    case DIAG_IOCTL_TYPE_UDP:
        ret = diag_ioctl_udp(nr, arg);
        break;

    case DIAG_IOCTL_TYPE_RESOURCE_IMAGE:
        ret = diag_ioctl_resource_image(nr, arg);
        break;
    case DIAG_IOCTL_TYPE_MIGRATE_IMAGE:
        ret = diag_ioctl_migrate_image(nr, arg);
        break;
    case DIAG_IOCTL_TYPE_SCHED_IMAGE:
        ret = diag_ioctl_sched_image(nr, arg);
        break;
    case DIAG_IOCTL_TYPE_TEST_MAP:
        ret = diag_ioctl_test_map(nr, arg);
        break;
    case DIAG_IOCTL_TYPE_KEYTIME_IMAGE:
        ret = diag_ioctl_keytime_image(nr, arg);
        break;
