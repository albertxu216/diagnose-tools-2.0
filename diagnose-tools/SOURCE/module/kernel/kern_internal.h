...
extern int diag_resource_image_init(void);
extern void diag_resource_image_exit(void);

extern int diag_migrate_image_init(void);
extern void diag_migrate_image_exit(void);

extern int diag_sched_image_init(void);
extern void diag_sched_image_exit(void);

extern int diag_keytime_image_init(void);
extern void diag_keytime_image_exit(void);

extern int diag_test_map_init(void);
extern void diag_test_map_exit(void);
